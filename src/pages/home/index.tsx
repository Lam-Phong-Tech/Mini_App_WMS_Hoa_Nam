      ...
      >
        ...
        <div className="mx-3.5">
          <button
            ...
            className="flex w-full items-center justify-between gap-3 rounded-xl bg-peach-fade bg-white p-4 text-left"
          >
            ...
            <div className="flex-shrink-0 rounded-full bg-primary px-4 py-2 text-xsmall text-white">
              {copy.home.customCtaButton}
            </div>
          </button>
        </div>
