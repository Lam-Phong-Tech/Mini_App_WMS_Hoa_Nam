...
| B00-02 | RESOLVED — USER-APPROVED FIXTURE | The user explicitly approved (`chốt`) `login-d07-390x844-dpr3.png` as the official Login fixture. It is app-only, `390×844` CSS px at DPR 3, and SHA-256 `e4a605d5f8e7d359dbc38b33a8656fce8bd7c868b3c96b862c655fe2f110498e`. | Keep this fixture frozen. Any visual change to Login requires a new explicit fixture approval. |
